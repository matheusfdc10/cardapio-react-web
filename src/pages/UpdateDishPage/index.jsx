...
const UpdateDishPage = () => {
  ...
  const UpdateDish = async () => {
    try {
      await updateDish(title, price, description, status, image, dishId, typeDishId)
      navigate(-1)
    } catch(err) {
      console.log(err)
    }
    ...
    <StyledUpdateDish>
      ...
      <div className="form">
        ...
        <div className="field">
          ...
          <textarea col='10px' cols="50" rows="4"
        ...
        <div className="field">
            <div className="radio">
                <input type="radio" name='status' id='ativo' value='ativo' checked={status == 'ativo'} onChange={(e) => setStatus(e.target.value)}/>
                <label htmlFor='ativo' >Ativo</label>
            </div>
            <div className="radio">
                <input type="radio" name='status' id='inativo' value='inativo' checked={status != 'ativo'} onChange={(e) => setStatus(e.target.value)}/>
